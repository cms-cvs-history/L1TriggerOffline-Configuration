...
process.p1 = cms.Path(process.L1Emulator*process.L1Extra*process.L1MuonMCAnalysis+process.L1IsoEmMCAnalysis+process.L1NonIsoEmMCAnalysis+process.L1CenJetMCAnalysis+process.L1ForJetMCAnalysis+process.L1TauJetMCAnalysis+process.L1MetMCAnalysis)
process.e = cms.EndPath(process.l1GtTrigReport)
process.TFileService.fileName = 'l1RerunVal.root'
process.l1GtTrigReport.L1GtRecordInputTag = 'hltGtDigis'
